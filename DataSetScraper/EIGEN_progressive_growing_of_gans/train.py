...
config.sched['max_minibatch_per_gpu'] = {256:16, 512: 8, 1024: 4}
# print(config.dataset)
config.train['network_snapshot_ticks'] = 25
config.train['total_kimg'] = 250
# print(config.grid)
...
def setup_snapshot_image_grid(G, training_set,
    size    = '512custom', # '1080p' = to be viewed on 1080p display, '4k' = to be viewed on 4k display.
