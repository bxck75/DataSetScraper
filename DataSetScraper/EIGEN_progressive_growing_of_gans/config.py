...
grid        = EasyDict(size='256custom', layout='random')       # Options for train.setup_snapshot_image_grid().

# Dataset (choose one).
desc += '-custom';            dataset = EasyDict(tfrecord_dir='ms13'); train.mirror_augment = False
# desc += '-ms13';            dataset = EasyDict(tfrecord_dir='ms13'); train.mirror_augment = True
...
desc += '-preset-v2-1gpu'; num_gpus = 1; sched.minibatch_base = 16; sched.minibatch_dict = {4: 64, 8: 64, 16: 64, 32: 32, 64: 32, 128: 16, 256: 8, 512: 4}; sched.G_lrate_dict = {1024: 0.0015}; sched.D_lrate_dict = EasyDict(sched.G_lrate_dict); train.total_kimg = 100
# desc += '-preset-v1-1gpu'; num_gpus = 1; D.mbstd_group_size = 16; sched.minibatch_base = 4; sched.minibatch_dict = {256: 14, 512: 6, 1024: 3}; sched.lod_training_kimg = 10; sched.lod_transition_kimg = 10; train.total_kimg = 100
# desc += '-preset-v2-1gpu'; num_gpus = 1; sched.minibatch_base = 4; sched.minibatch_dict = {4: 128, 8: 128, 16: 128, 32: 64, 64: 32, 128: 16, 256: 8, 512: 4}; sched.G_lrate_dict = {1024: 0.0015}; sched.D_lrate_dict = EasyDict(sched.G_lrate_dict); train.total_kimg = 100
