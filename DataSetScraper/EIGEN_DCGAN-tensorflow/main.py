...
import imageio
# im = imageio.imread('/root/Bureaublad/tools/datasets/dataset/fall/input/in000001.jpg')
# # im.shape  # im is a numpy array
# # (512, 512, 3)
# # skimage.transform.resize(im)
# imageio.imwrite('/root/Bureaublad/tools/datasets/dataset/fall/input/in000001a.jpg', im[:, :, 0])
...
flags.DEFINE_string("dataset", "input", "The name of dataset [celebA, mnist, lsun]")
...
flags.DEFINE_string("z_dist", "uniform_unsigned", "'normal01' or 'uniform_unsigned' or uniform_signed")
