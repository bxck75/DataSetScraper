...
# Dataset (choose one).
desc += '-custom';            dataset = EasyDict(tfrecord_dir='ms13'); train.mirror_augment = True
...
desc += '-preset-v2-1gpu'; num_gpus = 1; sched.minibatch_base = 16; sched.minibatch_dict = {4: 64, 8: 64, 16: 64, 32: 32, 64: 32, 128: 16, 256: 8, 512: 4}; sched.G_lrate_dict = {1024: 0.0015}; sched.D_lrate_dict = EasyDict(sched.G_lrate_dict); train.total_kimg = 300
