...
class Pinterest_Helper(object):
    ...
    def __init__(self, login, pw, browser = None):
        ...
        self.browser.get("https://www.pinterest.com/login?autologin=true")
    ...
    def getURLs(self, urlcsv, threshold = 500):
        ...
        results = []
        for t in tmp:
            tmp3 = self.runme_custom_(t, threshold)
    ...
    def runme_custom_(self,url, threshold = 500, persistence = 120, debug = False):
        final_results = []
        previmages = []
        tries = 0
        try:
